...
log_info "Mencari versi terbaru Prometheus..."
LATEST_VERSION=$(curl -sL "https://api.github.com/repos/prometheus/prometheus/releases/latest" | jq -r .tag_name | sed 's/^v//')

if [[ -z "$LATEST_VERSION" || "$LATEST_VERSION" == "null" ]]; then
  LATEST_VERSION="2.51.0" # Fallback stable
